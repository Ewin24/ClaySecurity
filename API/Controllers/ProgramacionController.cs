...
public class ProgramacionController : BaseController
{
    ...
    {
        var entidades = await _unitOfWork.Programaciones.GetAllAsync();
    ...
    {
        var entidad = await _unitOfWork.Programaciones.GetByIdAsync(id);
        if (entidad == null)
        {
            return NotFound();
        }
    ...
    public async Task<ActionResult<Programacion>> Post(ProgramacionDto ProgramacionDto)
    {
        ...
        this._unitOfWork.Programaciones.Add(entidad);
    ...
    public async Task<ActionResult<ProgramacionDto>> Put(int id, [FromBody] ProgramacionDto ProgramacionDto)
    {
        ...
        _unitOfWork.Programaciones.Update(entidades);
        await _unitOfWork.SaveAsync();
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        _unitOfWork.Programaciones.Delete(entidad);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}